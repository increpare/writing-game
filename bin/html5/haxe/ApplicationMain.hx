...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("data/graphics/bgtiles.png");
		...
		urls.push ("data/graphics/book_covermask.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("data/graphics/playerwalk1.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("data/graphics/playerwalk2.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("data/graphics/smallbook.png");
		types.push (lime.Assets.AssetType.IMAGE);
